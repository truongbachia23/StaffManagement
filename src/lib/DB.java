...
public class DB {
    private String DATABASE_MANAGEMENT_SYSTEM; // Hệ quản trị csdl : mysql, sqlServer
   ...
   /* public static void main(String[] args) {
    ...
    public DB() {
        ...
        DB_URL = "jdbc:" + DATABASE_MANAGEMENT_SYSTEM + "://" + HOST + ":" + PORT + "/" + DATABASE + "?zeroDateTimeBehavior=convertToNull&autoReconnect=true&useSSL=false&characterEncoding=utf8"; //Địa chỉ DataBase
